...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo bloginfo('template_url'); ?>/assets/img/favicon.png" rel="icon">
  <link href="<?php echo bloginfo('template_url'); ?>/img/apple-touch-icon.png" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="<?php echo bloginfo('template_url'); ?>/assets/vendor/animate.css/animate.min.css" rel="stylesheet">
